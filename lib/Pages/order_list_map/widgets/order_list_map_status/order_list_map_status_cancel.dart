...
class OrderListMapStatusCancel extends StatefulWidget {
  final OrderModels data;
  final StatusData status;
  final MapBloc mapBloc;
  final BuildContext contextBloc;

  const OrderListMapStatusCancel(
      {super.key,
      required this.data,
  ...
  @override
  State<OrderListMapStatusCancel> createState() =>
      _OrderListMapStatusCancelState();
}

class _OrderListMapStatusCancelState extends State<OrderListMapStatusCancel> {
